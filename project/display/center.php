<body class="home page page-id-93 page-template-default wpb-js-composer js-comp-ver-4.11.2.1 vc_responsive">
...
<li style="font-weight: 700;
    font-size: 16px;">Tổng đài vé Online:<a href="tel:19006469" style="font-weight: 700;
    font-size: 16px;"> 19006469</a></li>
</ul>
</div>
...
<li>
    ...
    <header >
        <div class="center-wrap">
            ...
            <nav>
                <ul id="menu-main-nav">
                    <li id="menu-item-570" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-570"><a href="index.php?page=gioithieu">Giới thiệu</a>

</li>
<li id="menu-item-672" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-672"><a href="index.php?page=lichtrinh">Lịch trình</a></li>
<li id="menu-item-619" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-619"><a href="phieudatve.php">Phiếu Đặt Vé</a>
</li>
<li id="menu-item-613" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-613"><a href="index.php?page=dichvu">Dịch vụ</a>
</li>
<li id="menu-item-657" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-657"><a href="http://localhost/project/admin/login.php">Đăng Nhập</a></li>
                </ul>
            </nav>
        </div><!-- end .center-wrap -->
    </header>
...
<script>
    var reslider1  = {
        id: '1',
        name: 'First Slider',
        params:JSON.parse('{"autoplay":1,"effect":{"type":0,"duration":1500,"interval":3000},"thumbnails":{"show":0,"positioning":0},"custom":{"type":"text"},"title":{"show":1,"position":"1","style":{"width":213,"height":61,"left":"571.375px","top":"14.7031px","color":"FFFFFF","opacity":0,"font":{"size":18},"border":{"color":"FFFFFF","width":1,"radius":2},"background":{"color":"FFFFFF","hover":"30FF4F"}}},"description":{"show":1,"position":"1","style":{"width":768,"height":116,"left":"16.375px","top":"345.703px","color":"FFFFFF","opacity":80,"font":{"size":14},"border":{"color":"3478FF","width":0,"radius":2},"background":{"color":"000000","hover":"000000"}}},"arrows":{"show":1,"type":1,"style":{"background":{"width":"49","height":"49","left":"91px 46px","right":"-44px 1px","hover":{"left":"91px 46px","right":"-44px 1px"},"free":{"width":"49","height":"49","left":"91px 46px","right":"-44px 1px","hover":{"left":"91px 46px","right":"-44px 1px"}}}}},"bullets":{"show":2,"type":"0","position":0,"autocenter":0,"rows":1,"s_x":10,"s_y":10,"orientation":1,"style":{"background":{"width":"60","height":"60","color":{"hover":"646464","active":"30FF4F","link":"CCCCCC"}},"position":{"top":"16px","left":"10px","free":{"top":"16px","left":"10px"}}}}}'),
        style:JSON.parse('{"background":"blue;","border":"1px solid red;","color":"yellow","width":"1920","height":"695","marginLeft":"0","marginRight":"0","marginTop":"0","marginBottom":"0"}'),
        custom:JSON.parse('{}'),
        count: '5',
        slides:{}
    };
        reslider1['slides']['slide'+'42'] = {};
        reslider1['slides']['slide'+'42']['id'] = '42';
        reslider1.slides['slide'+'42']['title'] = 'xe Phúc Lợi Cửa Lò';
        reslider1.slides['slide'+'42']['description'] = '';
        reslider1.slides['slide'+'42']['image_link'] = '';
        reslider1.slides['slide'+'42']['url'] = 'http://taubongsenvang.vn/wp-content/uploads/2018/05/cua-lo-1.jpg';
        reslider1.slides['slide'+'42']['type'] = '';
        reslider1.slides['slide'+'42']['custom'] = JSON.parse('{}');
        reslider1['slides']['slide'+'37'] = {};
        reslider1['slides']['slide'+'37']['id'] = '37';
        reslider1.slides['slide'+'37']['title'] = 'tàu bông sen vàng';
        reslider1.slides['slide'+'37']['description'] = '';
        reslider1.slides['slide'+'37']['image_link'] = '';
        reslider1.slides['slide'+'37']['url'] = 'http://taubongsenvang.vn/wp-content/uploads/2018/05/icons.jpg';
        reslider1.slides['slide'+'37']['type'] = '';
        reslider1.slides['slide'+'37']['custom'] = JSON.parse('{}');
        reslider1['slides']['slide'+'38'] = {};
        reslider1['slides']['slide'+'38']['id'] = '38';
        reslider1.slides['slide'+'38']['title'] = 'tau bong sen vang';
        reslider1.slides['slide'+'38']['description'] = '';
        reslider1.slides['slide'+'38']['image_link'] = '';
        reslider1.slides['slide'+'38']['url'] = 'http://taubongsenvang.vn/wp-content/uploads/2018/05/bong-sen-vang-01.jpg';
        reslider1.slides['slide'+'38']['type'] = '';
        reslider1.slides['slide'+'38']['custom'] = JSON.parse('{}');
        reslider1['slides']['slide'+'39'] = {};
        reslider1['slides']['slide'+'39']['id'] = '39';
        reslider1.slides['slide'+'39']['title'] = 'tàu bông sen vàng';
        reslider1.slides['slide'+'39']['description'] = '';
        reslider1.slides['slide'+'39']['image_link'] = '';
        reslider1.slides['slide'+'39']['url'] = 'http://taubongsenvang.vn/wp-content/uploads/2018/05/bong-sen-vang-02.jpg';
        reslider1.slides['slide'+'39']['type'] = '';
        reslider1.slides['slide'+'39']['custom'] = JSON.parse('{}');
        reslider1['slides']['slide'+'40'] = {};
        reslider1['slides']['slide'+'40']['id'] = '40';
        reslider1.slides['slide'+'40']['title'] = 'tàu bông sen vàng';
        reslider1.slides['slide'+'40']['description'] = '';
        reslider1.slides['slide'+'40']['image_link'] = '';
        reslider1.slides['slide'+'40']['url'] = 'http://taubongsenvang.vn/wp-content/uploads/2018/05/bong-sen-vang-03.jpg';
        reslider1.slides['slide'+'40']['type'] = '';
        reslider1.slides['slide'+'40']['custom'] = JSON.parse('{}');
</script>
<div id="slider1_container"  style="width: 1920px; height: 695px;">
    <div u="loading" class="reslide_loading">
      ...
      <!-- Slides Container --> 
        <div u="slides" class="reslide_slides">
                    <div class="slide1_42">
                                    <img u="image" src="wp-content/uploads/2018/05/cua-lo-1.jpg" alt="wp-content/uploads/2018/05/cua-lo-1.jpg"/>
                    <img u="thumb" src="wp-content/uploads/2018/05/cua-lo-1.jpg" alt="wp-content/uploads/2018/05/cua-lo-1.jpg"/>
                                                    <div class="reslidetitle">
                        <div></div>
                        <span>xe Phúc Lợi Cửa Lò</span>
                    </div>  
                                                
                        </div>
                   
                    <div class="slide1_38">
                                    <img u="image" src="wp-content/uploads/2018/05/bong-sen-vang-01.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-01.jpg"/>
                    <img u="thumb" src="wp-content/uploads/2018/05/bong-sen-vang-01.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-01.jpg"/>
                                                    <div class="reslidetitle">
                        <div></div>
                        <span>tau bong sen vang</span>
                    </div>  
                                                
                        </div>
                    <div class="slide1_39">
                                    <img u="image" src="wp-content/uploads/2018/05/bong-sen-vang-02.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-02.jpg"/>
                    <img u="thumb" src="wp-content/uploads/2018/05/bong-sen-vang-02.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-02.jpg"/>
                                                    <div class="reslidetitle">
                        <div></div>
                        <span>tàu bông sen vàng</span>
                    </div>  
                                                
                        </div>
                    <div class="slide1_40">
                                    <img u="image" src="wp-content/uploads/2018/05/bong-sen-vang-03.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-03.jpg"/>
                    <img u="thumb" src="wp-content/uploads/2018/05/bong-sen-vang-03.jpg" alt="wp-content/uploads/2018/05/bong-sen-vang-03.jpg"/>
                                                    <div class="reslidetitle">
                        <div></div>
                        <span>tàu bông sen vàng</span>
                    </div>  
...
#slider1_container .reslide_arrow_left,#slider1_container .reslide_arrow_right {
    ...
    height:  49px;
    cursor: pointer;
    background-image: url("wp-content/plugins/slider/Front_images/arrows/arrows-1.png");
    overflow: hidden;
    z-index: 9999;
}
   ...
   <script>
    ...
    //[Optional] Specifies default duration (swipe) for slide in milliseconds, default value is 500
        ...
        <div class="center-wrap">
            ...
            <form class="bolt-search" method="post" action="timkiemve.php">
                <h3>Mua vé trực tuyến</h3>
                <hr>
                                <input type="hidden" class="currentDate" value="10/08/2018" />

                <input type="hidden" name="agencyId" value="29">
                <div class="vc_row">
                    <div class="vc_col-sm-3">
                        <div class="form-group">
                            <label for="startPoint">Điểm đi:</label>
                            <select class="form-control" id="startPoint" name="diemdi" data-placeholder="Điểm đi" required6>
                                  <option></option>
                                <?php 

                    $query = "select * from gaden order by tenga asc";
                                                    $rows=$db->query($query);
                                                     foreach ($rows as $r) 
                                                     {
                    ...
                    <div class="vc_col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="endPoint" name="diemden" data-placeholder="Điểm đến" required>
                                <option></option>
                                <?php 

                    $query = "select * from gadi order by tengadi asc";
                                                    $rows=$db->query($query);
                                                     foreach ($rows as $r) 
                                                     {
                                                        echo "<option value='$r[0]'>$r[1]</option>";
                    ...
                    <div class="vc_col-sm-3">
                         <div class="form-group">
                            ...
                            <input autocomplete="off" type="text" name="ngaydi" class="form-control tcal tcalInput" placeholder="Ngày đi" id="startDate" required>
                        </div>
                        <div class="form-group">
                            <label for="startDate">Ngày về:</label>
                            <input autocomplete="off" type="text" name="ngayve" class="form-control tcal tcalInput" placeholder="Ngày về"  id="startDate" >
                        </div>
                        <div class="form-group">
                            <label for="startPoint">Loại vé</label>
                            <select class="form-control" name="loaive" data-placeholder="Loại vé" required>
...
<div class="s-block routes">
    ...
    <div class="center-wrap tt-relative">
        ...
        <div class="s-block-content route-list">        
            ...
            <ul class="route clearfix">  
                ...
                <li>    
                    ...
                    <h3>
                        ...
                        <a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-ha-noi-den-vinh-1a6">

                        Ga Hà Nội <span class="glyphicon glyphicon-arrow-right"> </span> Ga Sài Gòn </a></h3>

                    <div class="price-date">

                    <span class="price">1.050.000 đ</span>

                    <span class="date"><a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-ha-noi-den-vinh-1a6" class="ui-datepicker-trigger">Mua vé</a></span>
                ...
                <li>    
                    ...
                    <h3>
                        ...
                        <a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-vinh-den-ha-noi-6a1">

                        Ga Lạng Sơn <span class="glyphicon glyphicon-arrow-right"> </span> Ga Hà Nội </a></h3>

                    <div class="price-date">

                    <span class="price">850.000 đ</span>

                    <span class="date"><a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-vinh-den-ha-noi-6a1" class="ui-datepicker-trigger">Mua vé</a></span>
                ...
                <li>    
                    ...
                    <h3>
                        ...
                        <a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-ha-noi-den-dien-chau-1a29">

                        Ga Hà Nội <span class="glyphicon glyphicon-arrow-right"> </span> Ga Hải Phòng </a></h3>

                    <div class="price-date">

                    <span class="price">475.000 đ</span>

                    <span class="date"><a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-ha-noi-den-dien-chau-1a29" class="ui-datepicker-trigger">Mua vé</a></span>
                ...
                <li>    
                    ...
                    <h3>
                        ...
                        <a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-dien-chau-den-ha-noi-29a1">

                        Ga Hà Nội <span class="glyphicon glyphicon-arrow-right"> </span> Ga Đà Nẵng </a></h3>

                    <div class="price-date">

                    <span class="price">800.000 đ</span>

                    <span class="date"><a href="https://xeca.vn/tim-ve-xe/ve-xe-khach-tu-dien-chau-den-ha-noi-29a1" class="ui-datepicker-trigger">Mua vé</a></span>
...
<div id="s-latest_news" class="s-mod clearfix">
    <div class="center-wrap tt-relative">
    <div class="s-block article-latest">
        <div class="s-block-title-bg">
            <h3>
    ...
    <div class="s-block-content">
        <ul class="first">
                ...
                <li>
                    <a href="#" class="title">
                        <img width="210" height="160" src="wp-content/uploads/2018/04/dsvn.jpg" class="attachment-home-thumb size-home-thumb wp-post-image" alt="tàu bông sen vàng" />                        <span>Đường Sắt Việt Nam triển khai bán vé trực tuyến</span>
                    </a>
                    <div>
                        Từ ngày 01/10/2017, Đường Sắt Việt Nam triển khai chương trình bán vé tàu trực tuyến trên trang: https://dsvn.vn Khi sử dụng dịch vụ mua vé online, khách hàng sẽ: Tiết kiệm chi phí,...                    </div>
                </li>
                            
                   
                <li>
                    <a href="#" class="title">
                        <img width="210" height="160" src="wp-content/uploads/2018/08/vinh-9-210x160.jpg" class="attachment-home-thumb size-home-thumb wp-post-image" alt="vinh-9" />                        <span>Súp lươn Nghệ An, món ngon khó từ chối</span>
                    </a>
                    <div>
                        Theo Đông y, lươn có tác dụng bồi dưỡng khí huyết, tiêu trừ phong thấp, có thể chữa được bệnh suy dinh dưỡng, kiết lị, đau nhức xương sống, trĩ nội, phong...                    </div>
                </li>
               
                <li>
                    <a href="#" class="title">
                        <img width="210" height="160" src="wp-content/uploads/2018/04/dsvn.png" class="attachment-home-thumb size-home-thumb wp-post-image" alt="tau-bong-sen-vang-di-vinh-1" />                        <span>Đường Sắt Việt Nam thông báo lịch trình tuyến đường tháng 5</span>
                    </a>
                    <div>
                        Để thuận tiện hơn trong quá trình đăng ký vé hành trình Hà Nội &#8211; Sài Gòn và ngược lại, Đường Sắt Việt Nam thông báo lịch trình tuyến đường tháng 5....                    </div>
                </li>
               
                <li>
                    <a href="#" class="title">
                        <img width="210" height="160" src="wp-content/uploads/2018/07/132d5151639t5522l3-1-210x160.jpg" class="attachment-home-thumb size-home-thumb wp-post-image" alt="132d5151639t5522l3-1" />                        <span>Cá trích nướng Thạch Kim &#8211; ăn một lần nhớ mãi&#8230;</span>
                    </a>
                    <div>
                        Đi dọc cảng cá Thạch Kim (Lộc Hà, Hà Tĩnh), bất kể mùa nắng hay mùa mưa, ta vẫn nghe thơm lừng mùi cá trích nướng lẫn trong mùi khói than hồng,...                    </div>
                </li>
                    </ul>
    </div>
</div></div></div>
